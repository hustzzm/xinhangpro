...
const content = (
  <div>
    ...
    <div className="link">
      <a>
        <img alt="" src="zos/rmsportal/MjEImQtenlyueSmVEfUD.svg" /> 快速开始
      </a>
      <a>
        <img alt="" src="zos/rmsportal/NbuDUAuBlIApFuDvWiND.svg" /> 产品简介
      </a>
      <a>
        <img alt="" src="zos/rmsportal/ohOEPSYdDTNnyMbGuyLb.svg" /> 产品文档
      </a>
    </div>
  </div>
);
...
const extra = (
  <div className="imgContainer">
    <img style={{ width: '100%' }} alt="" src="zos/rmsportal/RzwpdLnhmvDJToTdfDPe.png" />
  </div>
);
