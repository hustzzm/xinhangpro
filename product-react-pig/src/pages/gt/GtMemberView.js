...
import { GTMEMBERINFO_DETAIL, GTMEMBERINFO_SUBMIT } from "../../actions/gt/gtmember";
...
@Form.create()
class GtMemberView extends PureComponent {
    state = {};
    ...
    componentWillMount() {
      ...
      dispatch(GTMEMBERINFO_DETAIL(selectedRow.id));
  }
    ...
    render() {
        ...
        return (
            <Panel back="/tester/list" action={action}>
                <Form>
